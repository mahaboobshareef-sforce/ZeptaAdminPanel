/*
  # Create Inventory Adjustment Function
  
  1. New Function
    - apply_inventory_adjustment with all required parameters
    - Validates inventory availability
    - Creates adjustment record
    - Triggers automatic bulk inventory update
  
  2. Security
    - SECURITY DEFINER for proper auth.uid() access
...
BEGIN
    ...
    -- The trigger trg_inventory_adjustment_update will automatically update bulk_inventory
